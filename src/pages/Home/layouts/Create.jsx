...
const Create = () => {
    const data = [
        {
            title: 'Vươn xa cùng đam mê',
            icon: '',
            colorbg: '#5142FC',
        },
        {
            title: 'Càng vẽ càng yêu',
            colorbg: '#47A432',
        },
        {
            title: 'Sắc màu yêu thương',
            colorbg: '#9835FB',
        },
        {
            title: 'Nét vẽ hồn nhiên',
            colorbg: '#DF4949',
        },
    ];
    return (
            ...
            <div className="themesflat-container">
                <div className="row">
                    <div className="col-md-12">
                        <div className="sc-box-icon-inner justify-content-around home3">
                            {data.map((item, index) => (
