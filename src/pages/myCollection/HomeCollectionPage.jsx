...
const HomeCollectionPage = () => {
  ...
  const { isLoading, isError, data, error } = useFetchData(GET_ALL_COLLECTION_BY_ACCOUNT,
    userInfo.Id);
                      ...
                      <div key={index}
                        ...
                        <div className="content flex justify-content-between">
                          ...
                          <div className="infor text-right">
                            ...
                            <button className={`${styles.tf_button_submit} mt-4 button-center`} onClick={handleShowModal}>Thêm bài vẽ</button>
                          </div>
                        </div>
                      </div>
                    ))
